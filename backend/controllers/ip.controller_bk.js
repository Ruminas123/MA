...
exports.check_status_ip = async (req, res) => {
  try {
    ...
    // ✅ บันทึก log summary ลง log_status
    await exports.save_log_data({
      summary: {
        totalIPs: ips.length,
...
// ✅ Save log data into log_status table
exports.save_log_data = async (data) => {
  try {
    const query = `
      INSERT INTO log_status (log_status_data, log_status_timestamp)
      VALUES ($1, NOW())
